...
------------ | ------------- | ------------- | -------------
**Name** | **string** |  | 
**Apps** | [**[]SourceControlManifestsGet200ResponseDataManifestsInnerAppsInner**](SourceControlManifestsGet200ResponseDataManifestsInnerAppsInner.md) |  | 

## Methods

### NewSourceControlManifestsGet200ResponseDataManifestsInner

`func NewSourceControlManifestsGet200ResponseDataManifestsInner(name string, apps []SourceControlManifestsGet200ResponseDataManifestsInnerAppsInner, ) *SourceControlManifestsGet200ResponseDataManifestsInner`
