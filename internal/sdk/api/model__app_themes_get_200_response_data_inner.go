...
// checks if the AppThemesGet200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppThemesGet200ResponseDataInner{}
...
type _AppThemesGet200ResponseDataInner AppThemesGet200ResponseDataInner

// NewAppThemesGet200ResponseDataInner instantiates a new AppThemesGet200ResponseDataInner object
...
func NewAppThemesGet200ResponseDataInner(id float32, legacyId float32, name string, theme map[string]interface{}, createdAt time.Time, updatedAt time.Time) *AppThemesGet200ResponseDataInner {
	this := AppThemesGet200ResponseDataInner{}
	this.Id = id
...
// NewAppThemesGet200ResponseDataInnerWithDefaults instantiates a new AppThemesGet200ResponseDataInner object
...
func (o *AppThemesGet200ResponseDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAppThemesGet200ResponseDataInner := _AppThemesGet200ResponseDataInner{}

	err = json.Unmarshal(data, &varAppThemesGet200ResponseDataInner)

	if err != nil {
		return err
	}

	*o = AppThemesGet200ResponseDataInner(varAppThemesGet200ResponseDataInner)
...
type NullableAppThemesGet200ResponseDataInner struct {
	value *AppThemesGet200ResponseDataInner
	isSet bool
}
...
func NewNullableAppThemesGet200ResponseDataInner(val *AppThemesGet200ResponseDataInner) *NullableAppThemesGet200ResponseDataInner {
	return &NullableAppThemesGet200ResponseDataInner{value: val, isSet: true}
}
