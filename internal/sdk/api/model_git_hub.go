...
// checks if the GitHub type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GitHub{}
...
// NewGitHub instantiates a new GitHub object
...
// NewGitHubWithDefaults instantiates a new GitHub object
...
func (o *GitHub) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varGitHub)
...
func NewNullableGitHub(val *GitHub) *NullableGitHub {
	return &NullableGitHub{value: val, isSet: true}
}
