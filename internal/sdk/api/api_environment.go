...
*/
func (a *EnvironmentAPIService) EnvironmentsEnvironmentIdDelete(ctx context.Context, environmentId string) ApiEnvironmentsEnvironmentIdDeleteRequest {
	return ApiEnvironmentsEnvironmentIdDeleteRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *EnvironmentAPIService) EnvironmentsEnvironmentIdDeleteExecute(r ApiEnvironmentsEnvironmentIdDeleteRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentsEnvironmentIdDelete")
	if err != nil {
...
*/
func (a *EnvironmentAPIService) EnvironmentsEnvironmentIdPatch(ctx context.Context, environmentId string) ApiEnvironmentsEnvironmentIdPatchRequest {
	return ApiEnvironmentsEnvironmentIdPatchRequest{
		ApiService: a,
		ctx: ctx,
		environmentId: environmentId,
...
func (a *EnvironmentAPIService) EnvironmentsEnvironmentIdPatchExecute(r ApiEnvironmentsEnvironmentIdPatchRequest) (*EnvironmentsEnvironmentIdPatch200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentsEnvironmentIdPatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *EnvironmentAPIService) EnvironmentsPost(ctx context.Context) ApiEnvironmentsPostRequest {
	return ApiEnvironmentsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EnvironmentAPIService) EnvironmentsPostExecute(r ApiEnvironmentsPostRequest) (*EnvironmentsPost200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentAPIService.EnvironmentsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
