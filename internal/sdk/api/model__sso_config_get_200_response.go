...
// checks if the SsoConfigGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SsoConfigGet200Response{}
...
type _SsoConfigGet200Response SsoConfigGet200Response
...
func (o *SsoConfigGet200Response) GetData() SsoConfigGet200ResponseData {
	if o == nil {
		var ret SsoConfigGet200ResponseData
		return ret
	}
...
func (o *SsoConfigGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSsoConfigGet200Response := _SsoConfigGet200Response{}

	err = json.Unmarshal(data, &varSsoConfigGet200Response)

	if err != nil {
		return err
	}

	*o = SsoConfigGet200Response(varSsoConfigGet200Response)
...
func NewNullableSsoConfigGet200Response(val *SsoConfigGet200Response) *NullableSsoConfigGet200Response {
	return &NullableSsoConfigGet200Response{value: val, isSet: true}
}
